        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="footer-widget">
                    ...
                    <p>Dapatsarpras singkatan dari Data Cepat Sarana dan Prasarana SMP, apalikasi berbasis web.</p>
                </div>
            </div>
            ...
            <!-- <div class="single-blog-post style-2 d-flex">
                        <div class="post-thumbnail">
                            <img src="{{ asset('front/img/bg-img/12.jpg') }}" alt="">
                        </div>
            ...
            <!-- <div class="single-blog-post style-2 d-flex">
                        <div class="post-thumbnail">
                            <img src="{{ asset('front/img/bg-img/13.jpg') }}" alt="">
                        </div>
                        <div class="post-content">
