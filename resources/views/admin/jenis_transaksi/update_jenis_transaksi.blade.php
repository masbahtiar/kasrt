...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card card-info">
            ...
            <form method="POST" class="form-horizontal" action="{{ route('admin.jenistransaksi.update') }}" id="updForm" novalidate>
                <div class="card-body">
                    @csrf
                    <input id="id" type="hidden" class="form-control" name="id" value="{{$jenistransaksi->id}}" required>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('nama_jtransaksi') ? ' has-error' : '' }}">
                            <input id="nama_jtransaksi" type="text" class="form-control" name="nama_jtransaksi" value="{{ $jenistransaksi->nama_jtransaksi }}" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('akun_debet') ? ' has-error' : '' }}">
                            <select class="form-control" id="qakunDebet" name="akun_debet">
                                ...
                                <option data-nmsubakun="{{ $value->nmsubakun }}" value="{{ $value->kdsubakun }}" {{$jenistransaksi->akun_debet == $value->kdsubakun?"selected":""}}>{{ $value->nmsubakun }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('akun_kredit') ? ' has-error' : '' }}">
                            <select class="form-control" id="qakunKredit" name="akun_kredit">
                                ...
                                <option data-nmsubakun="{{ $value->nmsubakun }}" value="{{ $value->kdsubakun }}" {{$jenistransaksi->akun_kredit == $value->kdsubakun?"selected":""}}>{{ $value->nmsubakun }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('nama_alias') ? ' has-error' : '' }}">
                            <input id="nama_alias" type="text" class="form-control" name="nama_alias" value="{{ $jenistransaksi->nama_alias }}" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('keterangan') ? ' has-error' : '' }}">
                            <input id="keterangan" type="text" class="form-control" name="keterangan" value="{{ $jenistransaksi->keterangan }}" required autofocus>
