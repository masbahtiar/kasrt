...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="{{ route('admin.akun.create') }}" class="btn btn-info btn-sm">
        ...
        <table id="tbllsuser" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" width="100%">
            <thead>
                <tr class="bg-gray" style="font-size:10pt; font: bold;">
                    ...
                    <th width="150">
                        <center>kode Sub Akun</center>
                    </th>
                    <th width="150">
                        <center>Nama Sub Akun</center>
                    </th>
                    <th>
