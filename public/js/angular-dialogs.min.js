...
(function() {
    var app = angular.module("ang-dialogs", ["ui.bootstrap"]);
    app.service("$dialogs", [
        "$uibModal",
        "$templateCache",
        "$log",
        ...
        function($uibModal, $templateCache, $log, $timeout, $interval) {
            ...
            this.showConfirmationDialog = function(message, config) {
                ...
                config.icon =
                    config.icon || "glyphicon glyphicon-question-sign";
                return this.showMessage(message, config);
            };
            ...
            this.showWarningDialog = function(message, config) {
                ...
                config.icon =
                    config.icon || "	glyphicon glyphicon-exclamation-sign";
                return this.showMessage(message, config);
            };
            this.showErrorDialog = function(message, config) {
                ...
                config.icon =
                    config.icon || "glyphicon glyphicon-remove-circle";
                return this.showMessage(message, config);
            };
                ...
                var modalInstance = $uibModal.open({
                    ...
                    controller: [
                        ...
                        function($scope, $uibModalInstance) {
                            $scope.config = config;
                            this.sendReportButtonHandler =
                                config.reportButtonHandler ||
                                function() {
                                    me.log("Not implemented", "error");
                                };
