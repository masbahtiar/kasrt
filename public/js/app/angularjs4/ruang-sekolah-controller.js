...
app.config(function($routeProvider, $locationProvider) {
    $routeProvider
        ...
        .when("/:id/itemruang/:idnmruang", {
            templateUrl: "../../templates3/itemruang-sekolah.html",
        ...
        .when(
            ...
            {
                templateUrl: "../../templates3/uploadkerusakan-sekolah.html",
...
app.controller("ruangCtrl", function($scope, $route, Sekolah, $routeParams) {
    ...
    $scope.removeRuang = function(id_nmruang) {
        var frmdata = { id_nmruang: id_nmruang, id_sekolah: $scope.id };
